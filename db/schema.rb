...
ActiveRecord::Schema.define(version: 2021_01_06_081032) do
  ...
  create_table "items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "dell_price_id", null: false
  ...
  create_table "ship_infos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["order_id"], name: "index_ship_infos_on_order_id"
  end
  ...
  add_foreign_key "ship_infos", "orders"
end
